...
export default function ScheduleSettings() {
  ...
  return (
    <div className="card">
      ...
      {settings?.is_enabled && (settings?.next_run_at || settings?.last_run_at) && (
        <div className="mb-6 p-3 rounded-lg bg-primary/10 border border-primary/20 space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-sm font-medium text-foreground">
                  {new Date(settings.next_run_at).toLocaleString(undefined, {
                    weekday: "short",
                    month: "short",
                    day: "numeric",
                    hour: "numeric",
          ...
          {settings?.last_run_at && (
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-sm font-medium text-foreground">
                  {new Date(settings.last_run_at).toLocaleString(undefined, {
                    weekday: "short",
                    month: "short",
                    day: "numeric",
                    hour: "numeric",
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-foreground/80 mb-2">
            Time ({getTimezoneDisplayName(settings?.schedule_timezone || timezone)})
          </label>
          <div className="flex items-center gap-2">
            <select
              value={hour12}
