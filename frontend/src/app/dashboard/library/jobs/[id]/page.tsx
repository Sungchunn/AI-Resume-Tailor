      ...
      <div className="card">
        <div className="flex items-start justify-between">
          <div>
            ...
            {job.company && (
              <p className="mt-1 text-lg text-foreground/80">{job.company}</p>
            )}
        ...
        <div>
          ...
          <pre className="whitespace-pre-wrap font-mono text-sm text-foreground/80 bg-muted p-4 rounded-lg border border-border">
            {job.raw_content}
          </pre>
        </div>
        ...
        {job.parsed_content && (
          <>
            <hr className="my-6 border-border" />
            <div>
              <h2 className="text-lg font-semibold text-foreground mb-4">Parsed Data</h2>
              <pre className="whitespace-pre-wrap font-mono text-sm text-foreground/80 bg-muted p-4 rounded-lg border border-border">
