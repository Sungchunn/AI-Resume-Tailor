...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Fixed sidebar - macOS style */}
      <aside
        className={`fixed top-0 left-0 bottom-0 bg-[#f5f5f5] flex flex-col transition-all duration-200 ease-out z-40 ${
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-16 h-6 w-6 bg-white border border-gray-200/80 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors shadow-sm"
                ...
                <Link
                  ...
                  className={`flex items-center gap-2.5 px-2.5 py-2.5 rounded-md text-sm font-medium transition-all duration-150 ${
                    isActive
                      ...
                      : "text-gray-600 hover:bg-black/4 active:bg-black/6"
        ...
        {/* User menu at bottom */}
        <div
          className={`py-3 ${isCollapsed ? "px-2" : "px-3"}`}
          ref={menuRef}
          style={{
        ...
        >
          <div className="relative">
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-2.5 py-2.5 rounded-md text-sm font-medium text-gray-600 hover:bg-black/4 active:bg-black/6 transition-all duration-150 ${
                isCollapsed ? "justify-center px-2" : ""
              }`}
              title={isCollapsed ? user?.full_name || user?.email || "User" : undefined}
            >
              <div className="h-7 w-7 shrink-0 rounded-full bg-linear-to-b from-gray-200 to-gray-300 flex items-center justify-center">
            ...
            {isUserMenuOpen && (
              <div
                className={`absolute bottom-full mb-1.5 bg-white rounded-lg shadow-lg py-1 z-50 ${
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-2.5 w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors text-left"
                >
                  <svg className="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
