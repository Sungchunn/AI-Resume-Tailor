...
export const STATUS_CONFIG: Record<ApplicationStatus, StatusConfig> = {
  ...
  interview: {
    label: "Interview",
    color: "amber",
    bgColor: "bg-amber-100 dark:bg-cyan-950",
    textColor: "text-amber-800 dark:text-cyan-300",
    borderColor: "border-amber-300 dark:border-cyan-800",
    icon: "Calendar",
  },
  accepted: {
    label: "Accepted",
  ...
  rejected: {
    label: "Rejected",
    color: "slate",
    bgColor: "bg-slate-200 dark:bg-slate-900",
