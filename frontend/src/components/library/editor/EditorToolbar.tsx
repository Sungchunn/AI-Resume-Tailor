...
import { Maximize2, Minimize2, FileText, Type, Lock, Check } from "lucide-react";
...
/**
 * EditorToolbar - Clean style controls panel for the block editor
 *
 * Features:
 * - Fit to one page toggle with nested min font slider
 * - Typography section with 2-column font grid
...
export function EditorToolbar({
  ...
  return (
    <div className="bg-card border-b border-border">
      ...
      {/* Content */}
      <div className="p-4 space-y-5 max-h-[calc(100vh-200px)] overflow-auto">
        {/* Page Fitting Card */}
