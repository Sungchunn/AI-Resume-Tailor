...
| ----- | ----------- | ----- |
| [Phase 1](./260312_phase-1-database.md) | Database models and migration | 3 new files |
| [Phase 2](./260312_phase-2-services.md) | Service layer modifications | 2 new, 2 modified |
| [Phase 3](./260312_phase-3-backend-api.md) | API endpoints and schemas | 3 new files |
| [Phase 4](./260312_phase-4-frontend.md) | Frontend dashboard | 4 new, 4 modified |
