...
1. `260305_phase-1-quick-wins.md` - Migration SQL, API changes, frontend updates
2. `260305_phase-2-ats-stepper.md` - Component design, SSE protocol, state machine
3. `260305_phase-3-analysis-page.md` - Page layout, navigation flow, error handling
4. `260305_phase-4-detail-refactor.md` - Score gating logic, sidebar implementation
5. `260305_phase-5-backend-enhancements.md` - Cache implementation, staleness detection
6. `260305_phase-6-testing-polish.md` - Test scenarios, documentation updates
