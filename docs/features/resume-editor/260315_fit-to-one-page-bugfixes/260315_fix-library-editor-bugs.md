...
1. Timing bug documented in `260315_fit-to-one-page-not-loading-fix.md` - measurements may not be ready when algorithm runs
...
- `260315_fix-render-and-toggle-bugs.md` - Previous (incorrect) plan targeting workshop components
- `260315_fit-to-one-page-not-loading-fix.md` - Timing bug fix for measurement readiness
- `260313_master-plan.md` - Original fit-to-one-page feature plan
