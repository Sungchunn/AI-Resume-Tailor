...
**Created:** 2026-03-13
**Status:** Planning
**Prerequisite For:** [Fit-to-One-Page](../fit-to-one-page/260313_master-plan.md) (Step 5: Save Coordination)
...
The fit-to-one-page feature requires **eager persistence** of auto-fitted styles. This introduces race condition risks documented in [Tradeoff 3: Eager Persistence](../fit-to-one-page/260313_tradeoff-3-eager-persistence.md).
...
| ----- | -------- | --------------- |
| 1 | [Backend OCC](./260313_phase-1-backend-occ.md) | Version field, atomic updates, HTTP 409 |
| 2 | [Frontend API](./260313_phase-2-frontend-api.md) | Types, error class, API client updates |
| 3 | [Save Coordinator](./260313_phase-3-save-coordinator.md) | `useSaveCoordinator` hook foundation |
| 4 | [BroadcastChannel](./260313_phase-4-broadcast-channel.md) | Cross-tab notification hook |
| 5 | [Conflict UI](./260313_phase-5-conflict-ui.md) | Modal, read-only state, BlockEditorProvider integration |
...
| -------- | ------------ |
| [Fit-to-One-Page Master Plan](../fit-to-one-page/260313_master-plan.md) | Parent feature requiring OCC |
| [Tradeoff 3: Eager Persistence](../fit-to-one-page/260313_tradeoff-3-eager-persistence.md) | Defines `useSaveCoordinator` hook |
| [Tradeoffs Summary](../fit-to-one-page/260313_tradeoffs-summary.md) | Lists OCC as medium-risk decision |
