...
| Document | Purpose |
| -------- | ------- |
| `260307_master-plan.md` | This document - overall architecture |
| `260307_phase1-state-management.md` | State foundation implementation |
| `260307_phase2-core-panel.md` | Core ATS panel components |
| `260307_phase3-keyword-actions.md` | Keyword insertion and vault integration |
