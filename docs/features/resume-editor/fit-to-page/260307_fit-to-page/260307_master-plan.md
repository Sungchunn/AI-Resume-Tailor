...
| ----- | ----------- | ----- |
| 1 | Backend - Page Count & Fit Endpoint | [260307_phase-1-backend-fit-endpoint.md](./260307_phase-1-backend-fit-endpoint.md) |
| 2 | Backend - Wire Styles to Export | [260307_phase-2-backend-wire-styles.md](./260307_phase-2-backend-wire-styles.md) |
| 3 | Backend - A4 Support | [260307_phase-3-backend-a4-support.md](./260307_phase-3-backend-a4-support.md) |
| 4 | Frontend - Server Validation | [260307_phase-4-frontend-validation.md](./260307_phase-4-frontend-validation.md) |
| 5 | Frontend - A4 Support & UI | [260307_phase-5-frontend-a4-ui.md](./260307_phase-5-frontend-a4-ui.md) |
