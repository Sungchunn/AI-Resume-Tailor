...
>
> **Relation to other plans:** Independent of `170326_true-inline-editing` (which replaced the overlay popup system). This plan is about conditional field visibility.
