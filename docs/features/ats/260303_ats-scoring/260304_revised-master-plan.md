...
**Supersedes:** `260303_ml-nlp-optimization-master-plan.md` (now deprecated)
...
**Sub-document:** `260304_knockout-check.md`
...
**Sub-document:** `260303_impl-structural-analysis.md` (update with section order)
...
**Sub-document:** `260304_keyword-scoring.md`
...
**Sub-document:** `260303_impl-content-quality.md` (update with quantification)
...
**Sub-document:** `260304_role-proximity.md`
...
| -------- | ------ | ------- |
| `260304_revised-master-plan.md` | **Active** | This document - overall architecture |
| `260304_knockout-check.md` | Pending | Stage 0: Knockout check design |
| `260304_keyword-scoring.md` | Pending | Stage 2: Enhanced keyword scoring |
| `260304_role-proximity.md` | ✅ Complete | Stage 4: Role proximity scoring |

### Implementation Documents (How to Build)

| Document | Status | Purpose |
| -------- | ------ | ------- |
| `260303_impl-keyword-extraction.md` | Active | Shared infra: ML/NLP keyword extraction |
| `260303_impl-structural-analysis.md` | ✅ Complete | Stage 1: Structural score with section order validation |
| `260303_impl-content-quality.md` | ✅ Complete | Stage 3: Content quality implementation |
| `260303_impl-resume-parser.md` | Active | Shared infra: Resume parser (feeds all stages) |
| `260303_impl-job-analyzer.md` | Update Pending | Shared infra: Job analyzer (feeds Stage 0 + 2) |
...
| 2026-03-04 | Initial creation, superseding 260303_ml-nlp-optimization-master-plan.md |
