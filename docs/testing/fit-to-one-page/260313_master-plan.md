...
**Created:** 2026-03-13
**Status:** Planning
**Related:** `/docs/features/fit-to-one-page/260313_master-plan.md`
**Infrastructure:** `260313_playwright-infrastructure.md`
...
This feature depends on real DOM measurements (`scrollHeight`, font metrics, line wrapping) that JSDOM cannot provide. See `/docs/features/fit-to-one-page/260313_tradeoff-2-coupling-preview-to-autofit.md` for detailed analysis.
...
| ----- | ----------- | -------- |
| 1 | Instrument components with test IDs | `260313_stage-1-instrumentation.md` |
| 2 | Configure Playwright projects | `260313_stage-2-playwright-config.md` |
| 3 | Create test infrastructure | `260313_stage-3-infrastructure.md` |
| 4 | Implement test suites | `260313_stage-4-test-suites.md` |
| 5 | Visual regression testing | `260313_stage-5-visual-regression.md` |
