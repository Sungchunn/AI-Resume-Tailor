...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('company_linkedin_url', sa.String(length=2000), nullable=True),
        sa.Column('company_address_locality', sa.String(length=255), nullable=True),
        sa.Column('company_address_country', sa.String(length=100), nullable=True),
